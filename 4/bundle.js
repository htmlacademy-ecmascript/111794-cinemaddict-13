...
/* harmony import */ var _view_film_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/film.js */ "./src/view/film.js");
/* harmony import */ var _view_button_load_more_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/button-load-more.js */ "./src/view/button-load-more.js");
/* harmony import */ var _view_popup_film_details_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/popup-film-details.js */ "./src/view/popup-film-details.js");
...
const films = new Array(FILMS_COUNT).fill().map(_mock_film_js__WEBPACK_IMPORTED_MODULE_8__["generateFilm"]);
...
if (filmsWatchingCount) {
  render(siteHeaderElement, Object(_view_rank_user_js__WEBPACK_IMPORTED_MODULE_0__["createRankUserTemplate"])(filmsWatchingCount), `beforeend`);
}
render(siteMainElement, Object(_view_group_menu_js__WEBPACK_IMPORTED_MODULE_1__["createGroupMenuTemplate"])(films), `beforeend`);
render(siteMainElement, Object(_view_filter_js__WEBPACK_IMPORTED_MODULE_2__["createFilterTemplate"])(), `beforeend`);
render(siteMainElement, Object(_view_board_js__WEBPACK_IMPORTED_MODULE_3__["createBoardTemplate"])(), `beforeend`);

const filmsBoard = document.querySelector(`.films`);
render(filmsBoard, Object(_view_board_main_js__WEBPACK_IMPORTED_MODULE_4__["createBoardMainTemplate"])(), `beforeend`);
...
for (let i = 0; i < films.slice(0, FILMS_ITERATOR).length; i++) {
  render(filmsBoardMainContainer, Object(_view_film_js__WEBPACK_IMPORTED_MODULE_5__["createFilmTemplate"])(films[i]), `beforeend`);
}
render(filmsBoardMain, Object(_view_button_load_more_js__WEBPACK_IMPORTED_MODULE_6__["createButtonLoadMoreTemplate"])(), `beforeend`);
...
buttonLoadMoreFilms.addEventListener(`click`, () => {
  if (index < FILMS_COUNT) {
    ...
    for (let i = 0; i < nextFilms.length; i++) {
      render(filmsBoardMainContainer, Object(_view_film_js__WEBPACK_IMPORTED_MODULE_5__["createFilmTemplate"])(nextFilms[i]), `beforeend`);
    }
...
/*!********************************!*\
  !*** ./src/view/board-main.js ***!
  \********************************/
/*! exports provided: createBoardMainTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createBoardMainTemplate", function() { return createBoardMainTemplate; });
...
/*!********************************!*\
  !*** ./src/view/group-menu.js ***!
  \********************************/
/*! exports provided: createGroupMenuTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createGroupMenuTemplate", function() { return createGroupMenuTemplate; });
...
/*!****************************************!*\
  !*** ./src/view/popup-film-details.js ***!
  \****************************************/
/*! exports provided: createPopupFilmDetailsTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createPopupFilmDetailsTemplate", function() { return createPopupFilmDetailsTemplate; });
...
/*!*******************************!*\
  !*** ./src/view/rank-user.js ***!
  \*******************************/
/*! exports provided: createRankUserTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
