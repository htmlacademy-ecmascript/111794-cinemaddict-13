...
class FilmsList {
  ...
  _handleFilmChange(updateFilm) {
    this._films = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_10__["updateItem"])(this._films, updateFilm);
  ...
  _renderGroupMenu() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardContainer, this._groupMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
  }

  _renderSortingMenu() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardContainer, this._sortingMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
  }

  _renderBoardContainer() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardContainer, this._boardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardComponent, this._boardMainComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardMainComponent, this._filmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
  }

  _renderFilms(from, to) {
    this._films
      .slice(from, to)
      .forEach((item) => Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._renderFilm(item)));
  }
  ...
  _handleButtonLoadMoreClick() {
    ...
    if (this._renderedFilmCount >= this._films.length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["remove"])(this._buttonLoadMoreComponent);
    }
  }

  _renderButtonLoadMore() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardMainComponent, this._buttonLoadMoreComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
    this._buttonLoadMoreComponent.setClickHandler(this._handleButtonLoadMoreClick);
  }

  _renderNoFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._boardContainer, this._noFilmComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["RenderPosition"].BEFOREEND);
  }
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: generateDuration, generateDate, generateComments, generateId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class SortingMenu extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
